...
namespace Drive.Sample
{
    ...
    class Program
    {
        ...
        private const string UploadFileName = @"2017新版《老鼠愛大米》香香 (13年後，再次演繹).mp4";

        // CHANGE THIS with a download directory
        private const string DownloadDirectoryName = @".";
        ...
        private async Task Run()
        {
            ...
            await UploadFileAsync(service, "GoogleDriveFileName", "GoogleDriveFileDescription", "FolderID","Type","LocalFileName");
